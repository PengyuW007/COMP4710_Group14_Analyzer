...
def displayPlotDTH(regionNum, title):
    ...
    ax.set_title(title, fontsize=15)
    ax.set_xlabel("Age Group")
    ax.set_ylabel("Percentage of Death")
    ax.legend()
...
def displayPlotHSP(regionNum, title):
    ...
    ax.set_title(title, fontsize=15)
    ax.set_xlabel("Age Group")
    ax.set_ylabel("Percentage of ICU")
    ax.legend()
...
def displayPlotASM_DTH(regionNum, title):
    ...
    ax.set_title(title, fontsize=15)
    ax.set_xlabel("Age Group")
    ax.set_ylabel("Percentage of Symptomatic and Death")
    ax.legend()
...
def displayPlotASM_HSP(regionNum, title):
    ...
    ax.set_title(title, fontsize=15)
    ax.set_xlabel("Age Group")
    ax.set_ylabel("Percentage of Symptomatic and ICU")
    ax.legend()
...
def displayPlotDTH_HSP(regionNum, title):
    ...
    ax.set_title(title, fontsize=15)
    ax.set_xlabel("Age Group")
    ax.set_ylabel("Percentage of Death and ICU")
    ax.legend()
...
def displayPlotASM_DTH_HSP(regionNum, title):
    ...
    ax.set_title(title, fontsize=15)
    ax.set_xlabel("Age Group")
    ax.set_ylabel("Percentage of Symptomatic and Death and ICU")
    ax.legend()
